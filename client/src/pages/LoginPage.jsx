  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (err.response?.status === 503) {
        setError('Login is unavailable because the database is not connected yet. Please check MongoDB Atlas access and try again.');
        return;
      }
  ...
  return (
    <div className="auth-page">
      <div className="auth-container">
        ...
        <p className="auth-helper-text">Google and Facebook icons are shown here for upcoming social login support.</p>
